...
Con el fin de medir algunas observaciones influyentes, se considera la distancia de Cook para este modelo.
...
Tanto el ACF como el PACF de los residuos de Pearson parece haber empeorado en este ajuste, pues se muestran más valores significativos que en el ajuste anterior.
...
Una vez elegido el modelo que se usará, se procede a predecir utilizando los datos de prueba, recordando que estos corresponden a 