...
# Cantidad de residuos mayores a 100 (porcentaje)
sum(resid_final > 100) / length(resid_final)

# Cantidad de residuos mayores a 1000 (porcentaje)
sum(resid_final > 1000) / length(resid_final)
```
