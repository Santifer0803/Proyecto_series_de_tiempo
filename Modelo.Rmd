...
Se redujo la cantidad de observaciones atípicas, de 33 a 14, en comparación al primer ajuste por tsglm. Por otro lado, parece que el rango de residuos se redujo ligeramente por abajo, pero aumentó considerablemente por arriba.
...
De los 3 modelos ajustados, se empleará el que no utiliza magnitudes para definir los valores atípicos, esto debido a que es el que minimiza las métricas de AIC y BIC.
